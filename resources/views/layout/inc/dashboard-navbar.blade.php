                        ...
                        @else
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
									...
									<li>
										<a href="{{ route('my-approvals') }}"><i class="lnr lnr-file-empty"></i>
                                            My Approvals</a>
									</li>
                                    <li>
                                        <a href="{{ route('logout') }}"
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="{{route('superadmin-view-records')}}" 
							class=" @if($route = Route::current()->getName() == 'superadmin-view-records') <?php echo "active" ?> @endif"
							><i class="lnr lnr-user"></i> <span>Student Attendances (Principal)</span></a>
						</li>
						@endif
						<li>
							<a href="/users" class="  <?php echo "active" ?>">
						...
						<li>
								...
								<div id="subStaffAt" class="collapse ">
									<ul class="nav">
											@if(auth()->user()->GetRole() === 2 || auth()->user()->GetRole() === 3)
						...
						<li>
							...
							><i class="lnr lnr-file-empty"></i> <span>Staff Approvals</span></a>
						</li>
						<li><a href="{{route('staff.classadvisor')}}" class=""><i class="lnr lnr-license"></i> Class Advisors</a></li>
						@endif
						...
						<li>
								...
								<div id="subStudAt" class="collapse ">
									<ul class="nav">
										...
										@if(auth()->user()->GetRole() === 3)
										<li><a href="{{route('student-attendance-special')}}" class="">Make Special Attendance</a></li>
										
										<li><a href="{{route('student-attendance-remove')}}" class="">Remove Attendance</a></li>
										@endif
										@if(auth()->user()->GetRole() === 1 || auth()->user()->GetRole() === 3)
										<li><a href="{{route('student-attendance-edit-permissions')}}" class="">Attendance Edit Permissions</a></li>
										@endif
										...
										<li >
											...
											<div id="subStudAtView" class="collapse">
												<ul class="nav">
													...
													<li><a href="{{route('student-attendance-view-month')}}" class="">Month (Day Hours status)</a></li>
													<li><a href="{{route('student-attendance-view-month-count')}}" class="">Month (Day Hours Count)</a></li>
